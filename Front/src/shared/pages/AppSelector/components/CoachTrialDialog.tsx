...
interface CoachTrialDialogProps {
  open: boolean;
...
export default function CoachTrialDialog({
  open,
  isProcessing,
  onClose,
  onAccept,
}: CoachTrialDialogProps) {
  return (
    <Dialog open={open} onClose={onClose} aria-labelledby="coach-trial-dialog">
