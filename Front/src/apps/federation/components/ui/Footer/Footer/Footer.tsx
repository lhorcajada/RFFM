    ...
    <div className={styles.root} role="contentinfo">
      <div className={styles.bar}>
        <IconButton
          ...
          className={
            loc.pathname.startsWith("/federation/dashboard")
        ...
        {showActions && (
          <>
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/get")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
              aria-label="Equipos"
            ...
            <IconButton
              ...
              state={{ resetToCurrent: true }}
              className={
                loc.pathname.startsWith("/federation/calendar")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
            ...
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/classification")
                  ? `${styles.iconBtn} ${styles.active}`
            ...
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/goleadores")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
            ...
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/callups")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
            ...
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/statistics")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
            ...
            <IconButton
              ...
              className={
                loc.pathname.startsWith("/federation/settings")
                  ? `${styles.iconBtn} ${styles.active}`
                  : styles.iconBtn
              }
