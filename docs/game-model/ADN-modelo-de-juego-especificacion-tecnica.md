...
`Habilidad.nombre` debe ser uno de estos veintisiete valores — cualquier nombre que no esté en esta lista es un error de importación, no una habilidad nueva silenciosa:

**Perfilamiento, Anticipación, Activación, Carga, Temporización, Comunicación, Entrada, Intercepción, Conducción, Protección de balón, Control orientado, Pase, Centro, Remate, Remate de cabeza, Vigilancia defensiva, Marcaje, Percepción, Regate, Desmarque, Cobertura, Despeje, Fijación, Juego de espaldas, Duelo aéreo, Cambio de orientación, Repliegue.**
