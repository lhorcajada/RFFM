# convocation-status-role-authorization Specification

## Purpose
TBD - created by archiving change restrict-player-family-desconvocado-reactivation. Update Purpose after archive.
## Requirements
