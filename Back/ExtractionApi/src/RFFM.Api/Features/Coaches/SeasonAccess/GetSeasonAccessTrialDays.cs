...
namespace RFFM.Api.Features.Coaches.SeasonAccess
{
    public class GetSeasonAccessTrialDays : IFeatureModule
    {
        ...
        public record GetSeasonAccessTrialDaysQuery(string SeasonId, string Category) : IQueryApp<IReadOnlyCollection<SeasonAccessTrialDayDto>>, IRequireFeaturePermission
        {
