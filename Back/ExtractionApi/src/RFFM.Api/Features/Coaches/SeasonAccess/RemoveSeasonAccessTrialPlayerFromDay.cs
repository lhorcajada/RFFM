...
namespace RFFM.Api.Features.Coaches.SeasonAccess
{
    public class RemoveSeasonAccessTrialPlayerFromDay : IFeatureModule
    {
        ...
        public record RemoveSeasonAccessTrialPlayerFromDayCommand(string DayId, string PlayerId) : RFFM.Api.Common.ICommand<SeasonAccessTrialDto?>, IRequireFeaturePermission
        {
